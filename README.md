...
The Expo app in `mobile/` is a **separate product**. v1 is convert-only: Home → Result. Convert goes through the locked `convertText` Cloud Function in `functions/`. The web flashcard app is unchanged.
