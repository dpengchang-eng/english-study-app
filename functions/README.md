...
This folder is **not used on Firebase Spark**. The mobile v1 convert path runs on the phone with Firebase AI Logic (existing Firebase app / `apiKey`). Do not deploy these functions on the no-cost plan.
